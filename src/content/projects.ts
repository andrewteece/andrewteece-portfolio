...
export const projects: Project[] = [
  {
    ...
    category: 'fullstack',
    featured: true,
    techStack: ['Next.js 15', 'TypeScript', 'Tailwind v4', 'Zustand', 'Radix UI', 'Recharts'],
    metrics: {
  ...
  },
  {
    ...
    image: 'images/job-prep.webp',
    category: 'fullstack',
    featured: true,
    techStack: ['Next.js 15', 'TypeScript', 'PostgreSQL', 'Drizzle ORM', 'Clerk', 'shadcn/ui'],
    metrics: {
